...
const Game = () => {
  ...
  const rollDice = () => {
    if (!selectedNumber) {
      // if the number is not selected dice wont roll and score wont change
    ...
    if (selectedNumber == randomNumber) {
      //this is used to increase the score based on condition if selected number and dice number(random number) match
